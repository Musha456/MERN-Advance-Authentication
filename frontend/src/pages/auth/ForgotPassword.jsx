    ...
    return (
        ...
        >
                ...
                {!isSubmitted ? (
                    ...
                    <p className='text-gray-300 mb-6 text-center'>
                        ...
                        <motion.button
                            ...
                            disabled={isLoading}
                        >
                            { isLoading ? <Loader className='w-6 h-6 animate-spin m-auto' /> : "Send Reset Link"}
                        </motion.button>
                    </form>
                ) : (
            ...
            <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
                <Link to={"/signin"} className='tex-sm text-green-400 hover:underline flex items-center'>
                    <ArrowLeft className='h-4 2-4 mr-2' /> Back To Login
                </Link>
            </div>
